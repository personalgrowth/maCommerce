      ...
      /*  if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<div class='prevPage'><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></div>\r\n";
        }*/
      /*  if($this->TotalResult == 0)
        {
            return "<div class='prevPage'><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></div>\r\n";
        }*/
        $purl = $this->GetCurUrl();
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<div class='prevPage'><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></div>\r\n";
            $indexpage="<div class='goHome'><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></div>\r\n";
        }
        else
        {
            $indexpage="<div class='goHome'><a href='/'>首页</a></div>\r\n";
        }

        //下一页,未页的链接
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<div class='nextPage'><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></li>\r\n";
           // $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
           // $endpage="<div class='nextPage'>末页</div>\r\n";
        }
